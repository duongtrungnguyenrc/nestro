...
@Injectable()
export class PlainClientService implements IClientService, OnModuleInit, BeforeApplicationShutdown {
  private intervalId: NodeJS.Timeout;
  private serverBaseUrl: string;

  constructor(@Inject(INSTANCE_INFO) private instanceInfo: Service, @Inject(SERVER_INFO) serverInfo: ServerInfo | URL) {
